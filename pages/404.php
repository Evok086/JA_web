<div class="mt-20">
    <main class="grid min-h-full place-items-center px-6 py-24 sm:py-32 lg:px-8">
        <div class="text-center">
            ...
            <h1 class="mt-4 text-balance text-4xl font-semibold tracking-tight text-teal-400 sm:text-7xl">Page non
                trouvée</h1>
            <p class="mt-6 text-pretty text-lg font-medium text-teal-500  sm:text-xl/8">Désolé, nous n'avons pas trouvée
