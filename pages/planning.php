<div class="relative overflow-x-auto shadow-md sm:rounded-lg mt-20 p-2">
    <table class="w-full text-sm text-left rtl:text-right text-blue-100 dark:text-blue-100">
        ...
        <thead>
            <tr>
                <th class="text-white p-1 blue-950">Date</th>
                <th class="text-white p-1 teal-950">Objet</th>
                <th class="text-white p-1 cyan-950">Description</th>
            </tr>
        </thead>
        <tbody>
            <tr>
            ...
            <tr>
                <td class="text-white p-1 bg-blue-500">15/12/2024</td>
                <td class="text-white p-1 bg-teal-500">Concert de fin d’année</td>
                <td class="text-white p-1 bg-cyan-500">
                    <a href="https://www.google.fr
                    /maps/place/Salle+Festive+Nantes+
                    Erdre/@47.25411,-1.533966,16z/data=
                    !3m1!4b1!4m6!3m5!1s0x4805ee4560ed32c
            ...
            <tr>
                <td class="text-white p-1 bg-blue-500">11/01/2025</td>
            ...
            <tr>
                ...
                <td class="text-white p-1 bg-teal-500">Réunion JA</td>
                <td class="text-white p-1 bg-cyan-500">10h pour tout le monde</td>
            </tr>
            <tr>
                <td class="text-white p-1 bg-blue-500">18/01/2025</td>
            ...
            <tr>
                ...
                <td class="text-white p-1 bg-teal-500">AMEB</td>
                <td class="text-white p-1 bg-cyan-500">
