<div class="basis-1/4 rounded-lg shadow-inner bg-cyan-700">
    <div class="p-6">
            ...
            <?php if (!empty($data->link)): ?>
                <div class="">
                    <a href="<?php echo htmlspecialchars($data->link, ENT_QUOTES, 'UTF-8'); ?>" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white 
                       bg-cyan-950 rounded-lg hover:cyan-950 focus:ring-4 focus:outline-none focus:ring-cyan-300 
                       dark:hover:cyan-950 dark:focus:ring-cyan-800">
